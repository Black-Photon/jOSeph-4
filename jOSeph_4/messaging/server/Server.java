package jOSeph_4.messaging.server;

import jOSeph_4.Variable;
import jOSeph_4.messaging.common.*;
...
import static jOSeph_4.messaging.common.State.*;
import static jOSeph_4.messaging.common.Special.*;
...
public class Server extends Common implements Initializable{
	...
	@Override public void initialize(URL location, ResourceBundle resources) {
		...
		closeRequest(Variable.getWindow(), Sides.SERVER);
		startConnection();
	}
	/**
	...
	@FXML void onBackPressed() {
		...
		Main.createWindow("Messaging.fxml", Variable.getWindow(), "Server");
	}
